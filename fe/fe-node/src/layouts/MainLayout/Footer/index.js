      ...
      <div className={`${classes.footer__down} container`}>
        <div className="row">
          <div className="col-12 col-md-1 p-1 text-center">
            <img src="/img/logo-connect/logoDHTL.png" alt="company" className={classes.logoCompany} />
          </div>
          <div className={`col-12 col-md-9 p-1 text-center text-lg-left`}>
            <span>Trường đại học Thủy Lợi</span>
            <span>Địa chỉ: 175 Tây Sơn, Phường Kim Liên, Hà Nội, Việt Nam.</span>
            <p>Email: <span className="d-inline">support@sp.vn</span></p>
          </div>
